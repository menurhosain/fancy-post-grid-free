...
<!-- ==== Blog Grid Layout 2 ==== -->
<section class="fpg-blog-layout-6 grey">
    <div class="container">
        <div class="row">
        ...
        <?php
            ...
            ?>
                ...
                <div class="<?php echo esc_attr($main_cl_lg . ' ' .  $main_cl_md . ' ' . $main_cl_sm . ' ' . $main_cl_mobile); ?>">
                    <div class="fpg-blog__single mt-30 <?php echo esc_attr($main_alignment_class); ?> <?php echo esc_attr($hover_class); ?>">
        ...
        <?php if ($fancy_post_pagination === 'on') : ?>
            <div class="fpg-pagination">
                ...
                $pagination_html = str_replace(
                    [
                        'class="page-numbers',                     // Basic
                        'class=\'page-numbers',                    // Single quotes
                        'class="next page-numbers',                // Next link
                        'class="prev page-numbers',                // Prev link
                        'class="page-numbers current',             // Current page
                    ],
                    [
                        'class="fpg-page-numbers',                 // Basic
                        'class=\'fancy-page-numbers',                // Single quotes
                        'class="fpg-page-numbers next',            // Next
                        'class="fpg-page-numbers prev',            // Prev
                        'class="fpg-page-numbers current',         // Current
                    ],
                    $pagination_html
                );
...
<style type="text/css">
    ...
    /* Single Item Styles */
    .fpg-blog-layout-6 .fpg-blog__single {
    ...
    /* Title Styles */
    .fpg-blog-layout-6 .fpg-blog__single .fpg-content .title {
    ...
    /* Title Styles */
    .fpg-blog-layout-6 .fpg-blog__single .fpg-content .title a {
    ...
    .fpg-blog-layout-6 .fpg-blog__single .fpg-content .fpg-excerpt{
    ...
    .fpg-blog-layout-6 .fpg-blog__single .fpg-content .fpg-excerpt p{
    ...
    .fpg-blog-layout-6 .fpg-blog__single .fpg-content .btn-wrapper{
    ...
    .fpg-blog-layout-6 .fpg-blog__single .fpg-content ul{
    ...
    .fpg-blog-layout-6 .fpg-blog__single .fpg-content ul li,
    .fpg-blog-layout-6 .fpg-blog__single .fpg-content ul li a,
    .fpg-blog-layout-6 .meta-data-list .meta-date i,
    .fpg-blog-layout-6 .meta-data-list .meta-author i,
    .fpg-blog-layout-6 .meta-data-list .meta-categories i,
    .fpg-blog-layout-6 .meta-data-list .meta-comment-count i,
    .fpg-blog-layout-6 .meta-data-list .meta-tags i,
     {
     ...
     .fpg-blog-layout-6 .fpg-blog__single .fpg-content ul li i{
    ...
    .fpg-blog-layout-6 .fpg-blog__single .fpg-content ul li a:hover{
    ...
    /* Button Styles */
    .fpg-blog-layout-6 .fpg-blog__single .fpg-content .fpg-link.<?php echo esc_attr($button_class); ?>{
    ...
    .fpg-blog-layout-6 .fpg-blog__single .fpg-content .fpg-link.<?php echo esc_attr($button_class); ?>:hover {
    ...
    .fpg-blog-layout-6 .fpg-blog__single .fpg-content .fpg-link.<?php echo esc_attr($button_class); ?>::before{
