...
?>
<!-- ==== Blog Grid Layout 2 ==== -->
<section class="fpg-blog-layout-28">
    <div class="container">
        <div class="row">
        ...
        ?>
            ...
            <div class="<?php echo esc_attr($main_cl_lg . ' ' .  $main_cl_md . ' ' . $main_cl_sm . ' ' . $main_cl_mobile); ?>">
                <div class="fpg-blog-layout-28-item <?php echo esc_attr($main_alignment_class); ?> <?php echo esc_attr($hover_class); ?>">
                    ...
                    <div class="fpg-content">
                        ...
                        <?php if ($fpg_field_group_read_more) : ?>
                            <div class="btn-wrapper <?php echo esc_attr($button_alignment_class); ?>">
                                <a class="fpg-btn <?php echo esc_attr($button_class); ?>" href="<?php the_permalink(); ?>" <?php echo esc_attr($target_blank); ?>>
...
<style type="text/css">
    ...
    /* Single Item Styles */
    .fpg-blog-layout-28 .fpg-blog-layout-28-item {
    ...
    /* Title Styles */
    .fpg-blog-layout-28-item .fpg-content .title {
    ...
    /* Title Styles */
    .fpg-blog-layout-28-item .fpg-content .title a {
    ...
    .fpg-blog-layout-28-item .fpg-content .title a:hover {
    ...
    /* Excerpt Styles */
    .fpg-blog-layout-28-item .fpg-content .fpg-excerpt {
    ...
    .fpg-blog-layout-28-item .fpg-content .fpg-excerpt p{
    ...
    .fpg-blog-layout-28-item .fpg-content .btn-wrapper{
    ...
    .fpg-blog-layout-28 .fpg-blog__single .fpg-content ul{
    ...
    .fpg-blog-layout-28-item .fpg-thumb .fpg-meta{
    ...
    .fpg-blog-layout-28-item .fpg-thumb .fpg-meta::before{
        <?php if (!empty($fpg_primary_color) || !empty($fpg_meta_bgcolor)) : ?>
    ...
    .fpg-blog-layout-28-item .fpg-thumb .fpg-meta ul li a,
    .fpg-blog-layout-28-item .fpg-thumb .fpg-meta ul li {
    ...
    .fpg-blog-layout-28-item .fpg-thumb .fpg-meta ul li::after{
        <?php if (!empty($fpg_meta_color)) : ?>
            color: <?php echo esc_attr($fpg_meta_color); ?>;
        <?php endif; ?>
    }
    ...
    /* Button Styles */
    .fpg-blog-layout-28-item .fpg-content .fpg-btn.<?php echo esc_attr($button_class); ?>{
    ...
    .fpg-blog-layout-28-item .fpg-content .fpg-btn.<?php echo esc_attr($button_class); ?>:hover {
    ...
    .fpg-blog-layout-28-item .fpg-content .fpg-btn.<?php echo esc_attr($button_class); ?>::before{
