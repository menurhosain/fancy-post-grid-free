...
?>
<!-- Blog List Layout 1 -->
<section class="fpg-blog-layout-8">
    <div class="container">
        <div class="row">
            <?php               
            ...
            ?>
                <?php if ($query->current_post === 0) : ?>
                    ...
                    <div class="col-lg-5">
                        <div class="fpg-blog__left-blog <?php echo esc_attr($main_alignment_class); ?> <?php echo esc_attr($hover_class); ?>">
                            <!-- Image -->
                    ...
                    <div class="col-lg-7">
                        <?php elseif ($query->current_post === 1) : ?>
                            <div class="fpg-blog__left-blog right-blog <?php echo esc_attr($main_alignment_class); ?> <?php echo esc_attr($hover_class); ?>"> 
...
<style type="text/css">
    ...
    .fpg-blog-layout-8 .fpg-blog__left-blog, .fpg-blog-layout-8 .fpg-blog__left-blog .right-blog{
    ...
    .fpg-blog-layout-8 .fpg-blog__left-blog {
    ...
    .fpg-blog-layout-8 .fpg-blog__thumb .fpg-category i,
    .fpg-blog-layout-8 .fpg-blog__thumb .fpg-category a{
        <?php if (!empty($fpg_category_color)) : ?>
            color: <?php echo esc_attr($fpg_category_color); ?>;
        <?php endif; ?>

    }
    .fpg-blog-layout-8 .fpg-blog__left-blog .fpg-blog__content ul,
    .fpg-blog-layout-8 .fpg-blog__left-blog.right-blog .fpg-blog__content ul{
    ...
    .fpg-blog-layout-8 .fpg-blog__content ul li,
    .fpg-blog-layout-8 .fpg-blog__content ul li i,.fpg-blog-layout-8 .fpg-blog__content ul li a{
    ...
    .fpg-blog-layout-8 .fpg-blog__content ul li i{
    ...
    .fpg-blog-layout-8 .fpg-blog__content ul li:hover,.fpg-blog-layout-8 .fpg-blog__content ul li a:hover{
        <?php if (!empty($fpg_meta_hover_color)) : ?>
            color: <?php echo esc_attr($fpg_meta_hover_color); ?>;
        <?php endif; ?>
    }
    .fpg-blog-layout-8 .fpg-blog__left-blog.right-blog .fpg-blog__content .title,
    .fpg-blog-layout-8 .fpg-blog__content .title{
    ...
    .fpg-blog-layout-8 .fpg-blog__content .title a{
    ...
    .fpg-blog-layout-8 .fpg-blog__content .title a:hover{
        <?php if (!empty($fpg_primary_color) || !empty($fpg_meta_icon_color)) : ?>
            color: <?php echo esc_attr(!empty($fpg_primary_color) ? $fpg_primary_color : $fpg_meta_icon_color); ?>;
        <?php endif; ?>  
    }
    .fpg-blog-layout-8 .fpg-blog__content .fpg-excerpt{
    ...
    .fpg-blog-layout-8 .fpg-blog__content .fpg-excerpt p{
    ...
    .fpg-blog-layout-8 .fpg-blog__content .btn-wrapper{
        <?php if (!empty($fpg_button_order)) : ?>
            order: <?php echo esc_attr($fpg_button_order); ?>;
        <?php endif; ?>
    }
    .fpg-blog-layout-8 .fpg-blog__content .btn-wrapper a.fpg-link.<?php echo esc_attr($button_class); ?>{
    ...
    .fpg-blog-layout-8 .fpg-blog__content .btn-wrapper a.fpg-link.<?php echo esc_attr($button_class); ?>:hover{
    ...
    .fpg-blog-layout-8 .fpg-blog__content .btn-wrapper a.fpg-link.<?php echo esc_attr($button_class); ?>::before{
