        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="swiper_wrap">
                     <div class="swiper mySwiper <?php echo esc_attr($unique_id); ?>" 
                        data-swiper='{
                    ...
                    <?php if ($fancy_pagination === 'true') : ?>
                        <div class="swiper-pagination swiper-pagination-1 <?php echo esc_attr($pagination_class); ?>"></div>
                    <?php endif; ?>
...
<style type="text/css">
    ...
    .fpg-blog-layout-1 .blog-item .blog-content {
    ...
    /* Title Styles */
    .fpg-blog-layout-1 .blog-item .blog-content .blog-title a {
    ...
    .fpg-blog-layout-1 .blog-item .blog-content .blog-title a:hover {
    ...
    /* Excerpt Styles */
    .fpg-blog-layout-1 .blog-item .blog-content .desc{
        <?php if (!empty($fpg_excerpt_order)) : ?>
            order: <?php echo esc_attr($fpg_excerpt_order); ?>;
        <?php endif; ?>
    }
    .fpg-blog-layout-1 .blog-item .blog-content .desc p{
    ...
    .fpg-blog-layout-1 .blog-item .blog-content .blog-meta{
    ...
    .fpg-blog-layout-1 .blog-item .blog-content .blog-meta li,
    .fpg-blog-layout-1 .blog-item .blog-content .blog-meta li i,
    .fpg-blog-layout-1 .blog-item .blog-content .blog-meta li a,
    .fpg-blog-layout-1 .blog-item .blog-content .blog-meta i
    ...
    .fpg-blog-layout-1 .blog-item .blog-content .blog-meta li a:hover{
    ...
    /* Button Styles */
    .fpg-blog-layout-1 .blog-item .blog-content .blog-btn{
        <?php if (!empty($fpg_button_order)) : ?>
            order: <?php echo esc_attr($fpg_button_order); ?>;
        <?php endif; ?>

    }
    .fpg-blog-layout-1 .blog-item .blog-content .blog-btn .read-more.<?php echo esc_attr($button_class); ?>{
    ...
    .fpg-blog-layout-1 .blog-item .blog-content .blog-btn .read-more.<?php echo esc_attr($button_class); ?>:hover {
    ...
    .fpg-blog-layout-1 .blog-item .blog-content .blog-btn .read-more.<?php echo esc_attr($button_class); ?>::before{
        <?php if (!empty($fpg_button_border_color)) : ?>
            background: <?php echo esc_attr($fpg_button_border_color); ?>;
        <?php endif; ?>
        <?php if (!empty($fpg_primary_color) || !empty($fpg_button_text_hover_color)) : ?>
            background: <?php echo esc_attr(!empty($fpg_primary_color) ? $fpg_primary_color : $fpg_button_text_hover_color); ?>;
        <?php endif; ?> 
    }

    .fpg-blog-layout-1 .swiper_wrap .swiper-pagination-progressbar,
    .fpg-blog-layout-1 .swiper_wrap .swiper-pagination .swiper-pagination-bullet{
        <?php if (!empty($fpg_slider_dots_color)) : ?>
            background: <?php echo esc_attr($fpg_slider_dots_color); ?>;
        <?php endif; ?>
    }
    .fpg-blog-layout-1 .swiper_wrap .swiper-pagination-progressbar .swiper-pagination-progressbar-fill,
    .fpg-blog-layout-1 .swiper_wrap .swiper-pagination .swiper-pagination-bullet.swiper-pagination-bullet-active{
    ...
    .fpg-blog-layout-1 .swiper_wrap .swiper-button-next,
    .fpg-blog-layout-1 .swiper_wrap .swiper-button-prev{
    ...
    .fpg-blog-layout-1 .swiper_wrap .swiper-button-next:hover,
    .fpg-blog-layout-1 .swiper_wrap .swiper-button-prev:hover{
        <?php if (!empty($fpg_arrow_bg_hover_color)) : ?>
            background: <?php echo esc_attr($fpg_arrow_bg_hover_color); ?>;
        <?php endif; ?>
    }

.fpg-blog-layout-1 .swiper_wrap .swiper-button-next::after,
.fpg-blog-layout-1 .swiper_wrap .swiper-button-prev::after{
...
.fpg-blog-layout-1 .swiper_wrap .swiper-button-next:hover::after,
.fpg-blog-layout-1 .swiper_wrap .swiper-button-prev:hover::after{
    <?php if (!empty($fpg_arrow_hover_color)) : ?>
        color: <?php echo esc_attr($fpg_arrow_hover_color); ?>;
    <?php endif; ?>
}

.fpg-blog-layout-1 .swiper_wrap .swiper-pagination-fraction{
...
.fpg-blog-layout-1 .swiper_wrap .swiper-pagination-fraction .swiper-pagination-current{
