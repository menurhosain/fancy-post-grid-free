(function (wp) {
    ...
    const { PanelBody, TabPanel,__experimentalBoxControl  , RangeControl,ColorPicker,Button , ToggleControl, TextControl, SelectControl,FormTokenField  } = wp.components;
    ...
    registerBlockType('fancy-post-grid/block', {
        ...
        attributes: {
            ...
            buttonBorderType: { type: 'string' },
            buttonBorderRadius: { type: 'object' },
            buttonFontWeight: { type: 'string' },
            buttonBorderWidth: { type: 'object' },
            buttonHoverTextColor: { type: 'string' },
            buttonHoverBackgroundColor: { type: 'string'},
            buttonBorderColor: { type: 'string' },
            buttonHoverBorderColor: { type: 'string'},
           
            //Pagination
            paginationMarginNew: { type: 'object' },
            paginationPaddingNew: { type: 'object' },             
            paginationAlignment: { type: 'string'},
            paginationBorderStyle: { type: 'string' },
            paginationBorderRadius: { type: 'object' },
            paginationBorderWidthNew: { type: 'object' },
            paginationGap: { type: 'number' },
            paginationFontSize: { type: 'number' },
            paginationTextColor: { type: 'string' },
            paginationBackgroundColor: { type: 'string' },
            paginationBorderColor: { type: 'string' },
            paginationHoverTextColor: { type: 'string' },
            paginationHoverBackgroundColor: { type: 'string' },
            paginationHoverBorderColor: { type: 'string'},
            paginationActiveTextColor: { type: 'string' },
            paginationActiveBackgroundColor: { type: 'string' },
            paginationActiveBorderColor: { type: 'string' },
        ...
        edit: function ({ attributes, setAttributes }) {
            const { 
                ...
                ,selectedCategories, selectedTags,orderBy, postLimit,enablePagination,
                postLinkTarget,thumbnailLink,postLinkType,includePosts,excludePosts,
                ...
                paginationNumbers.push(
                    wp.element.createElement(
                        ...
                        wp.element.createElement(
                            'span',
                            {
                                className: `fpg-page-numbers${currentPage === i ? ' current' : ''}`,
                                style: {
                ...
                'ul',
                {
                    ...
                    wp.element.createElement(
                        ...
                        wp.element.createElement(
                            'a',
                            {
                                className: 'prev fpg-page-numbers',
                                style: {
                                    ...(attributes.paginationPaddingNew ? { padding: getSpacingValue(attributes.paginationPaddingNew) } : {}),
                    ...
                    wp.element.createElement(
                        ...
                        wp.element.createElement(
                            'a',
                            {
                                ...
                                className: 'next fpg-page-numbers',
                                style: {
                                    ...(attributes.paginationBackgroundColor ? { backgroundColor: attributes.paginationBackgroundColor } : {}),
                                    ...(attributes.paginationPaddingNew ? { padding: getSpacingValue(attributes.paginationPaddingNew) } : {}),
                                    ...(attributes.paginationTextColor ? { color: attributes.paginationTextColor } : {}),
            ...
            if (gridLayoutStyle === 'style1' && posts && posts.length) {
                content = wp.element.createElement(
                          ...
                          wp.element.createElement('style', null, `
                              ...
                              .fpg-blog-layout-5 .fpg-blog__single .fpg-content .fpg-link.fpg-border::before {
                ...
                wp.element.createElement(
                    'div',
                    { 
                        className: 'fpg-blog-layout-5 fancy-post-grid', 
                        style: { 
                            display: 'grid', 
                    ...
                    posts.map((post) => {
                        ...
                        return wp.element.createElement('div', { 
                            key: post.id, 
                                className: `fancy-post-item fpg-blog__single align-${itemBoxAlignment1} ${hoverAnimation} ${postLinkType}`,
                                style: {
                ...
                content = wp.element.createElement(
                          ...
                          wp.element.createElement('style', null, `
                              ...
                              .fpg-blog-layout-6 .fpg-blog__single .fpg-content .fpg-link.fpg-border::before {
                                  background: ${attributes.buttonHoverTextColor || '#332FFF'};
                              },
                          `),
                  wp.element.createElement(
                    'div',
                    { 
                        className: 'fpg-blog-layout-6 fancy-post-grid', 
                        style: { 
                            display: 'grid', 
                    ...
                    posts.map((post) => {
                        ...
                        return wp.element.createElement('div', { 
                            key: post.id, 
                                className: `fancy-post-item fpg-blog__single mt-30 align-${itemBoxAlignment2} ${hoverAnimation} ${postLinkType}`,
                                style: {
                ...
                content = wp.element.createElement(
                  ...
                  wp.element.createElement(
                    'div',
                    { 
                        className: 'fpg-blog-layout-28 fancy-post-grid', 
                        style: { 
                            display: 'grid', 
                    ...
                    posts.map((post) => {
                        ...
                        const thumbnail = post._embedded?.['wp:featuredmedia']?.[0]?.media_details?.sizes?.[thumbnailSize3]?.source_url || post._embedded?.['wp:featuredmedia']?.[0]?.source_url || '';
                            ...
                            return wp.element.createElement('div', { 
                                key: post.id, 
                                    className: `fancy-post-item fpg-blog-layout-28-item align-${itemBoxAlignment3} ${hoverAnimation} ${postLinkType}`,
                                    style: {
                                        ...(attributes.itemMargin
                                          ? { margin: getSpacingValue(attributes.itemMargin) }
                                          : { margin: '40px 0px 0px 0px' }), // your default fallback
                ...
                content = wp.element.createElement(
                    'div',
                    { 
                        className: 'fpg-blog-layout-30 fancy-post-grid', 
                        style: { 
                            display: 'grid', 
                    ...
                    posts.map((post) => {
                        ...
                        return wp.element.createElement('div', { 
                            key: post.id, 
                                className: `fancy-post-item fpg-blog-layout-30-item align-${itemBoxAlignment4} ${hoverAnimation} ${postLinkType}`,
                                style: {
                ...
                content = wp.element.createElement(
                          ...
                          wp.element.createElement('style', null, `
                              .pre-blog-item.style_12:after {
                                  ...
                                  border-color: ${attributes.itemBorderColor || '#332FFF'};
                              ...
                              .pre-blog-item.style_12:hover .blog-inner-wrap .pre-blog-content {
                                  background: ${attributes.contentHoverBgColor || '#332FFF'};
                              },
                          `),
                wp.element.createElement(
                    'div',
                    { 
                        className: 'fpg-blog-layout-12 fancy-post-grid', 
                        style: { 
                            display: 'grid', 
                    ...
                    posts.map((post) => {
                        ...
                        return wp.element.createElement('div', { 
                            key: post.id, 
                                className: `fancy-post-item pre-blog-item style_12 pre-blog-meta-style2 default align-${itemBoxAlignment5} ${postLinkType}`,
                                style: { 
                                    ...(attributes.itemMargin
                                      ? { margin: getSpacingValue(attributes.itemMargin) }
                                      : { margin: '40px 0px 0px 0px' }), // your default fallback
                            ...
                            wp.element.createElement('div', { className: 'pre-blog-content',style: {
                                ...
                                showPostTitle &&
                                  wp.element.createElement(
                                      titleTag,
                                      {
                                          className: `pre-post-title align-${postTitleAlignment}${showUnderline ? ' underline' : ''}`,
                                          style: {
                                              ...(attributes.postTitleMargin
                                                  ? { margin: getSpacingValue(attributes.postTitleMargin) }
                                                  : { }),
                ...
                content = wp.element.createElement(
                          ...
                          wp.element.createElement('style', null, `
                              ...
                              .fpg-blog-layout-13-item .fpg-thumb .pre-blog-meta::after {
                                  border-style:  solid ;
                                  border-width:  1px 1px 1px 1px ;
                                  border-color: ${attributes.metaBgColor || '#fff'};
                              }
                              .fpg-blog-layout-13-item .fpg-content .blog-btn.fpg-border::before {
                ...
                wp.element.createElement(
                    'div',
                    { 
                        className: 'fpg-blog-layout-13 fancy-post-grid', 
                        style: { 
                            display: 'grid', 
                    ...
                    posts.map((post) => {
                        ...
                        return wp.element.createElement('div', { 
                            key: post.id, 
                                className: `fancy-post-item fpg-blog-layout-13-item align-${itemBoxAlignment6} ${hoverAnimation} ${postLinkType}`,
                                style: {
                                    ...(attributes.itemMargin
                                      ? { margin: getSpacingValue(attributes.itemMargin) }
                                      : { margin: '40px 0px 0px 0px' }), // your default fallback
                ...
                content = wp.element.createElement(
                    'div',
                    { 
                        className: 'fpg-blog-layout-14 fancy-post-grid', 
                        style: { 
                            display: 'grid', 
                    ...
                    posts.map((post) => {
                        ...
                        return wp.element.createElement('div', { 
                            key: post.id, 
                                className: `fancy-post-item fpg-blog-layout-14-item align-${itemBoxAlignment7} ${hoverAnimation} grey ${postLinkType}`,
                                style: {
                                    ...(attributes.itemMargin
                                      ? { margin: getSpacingValue(attributes.itemMargin) }
                                      : { margin: '40px 0px 0px 0px' }), // your default fallback
                            ...
                            wp.element.createElement('div', { className: 'fpg-content',
                                ...
                                showPostDate && wp.element.createElement(
                                    'div', 
                                        { className: `fpg-meta post-meta align-${metaAlignment}`, style: { 
                                            color: metaTextColor, 
                                            fontSize: `${metaFontSize}px`,
                                        } },
                                        wp.element.createElement(
                ...
                content = wp.element.createElement(
                    'div',
                    { 
                        className: 'fpg-blog-layout-15 fancy-post-grid', 
                        style: { 
                            display: 'grid', 
                    ...
                    posts.map((post) => {
                        ...
                        return wp.element.createElement('div', { 
                            key: post.id, 
                                className: `fancy-post-item fpg-blog-layout-15-item align-${itemBoxAlignment8} ${hoverAnimation} ${postLinkType}`,
                                style: {
                                    ...(attributes.itemMargin
                                      ? { margin: getSpacingValue(attributes.itemMargin) }
                                      : { margin: '40px 0px 0px 0px' }), // your default fallback
                ...
                content = wp.element.createElement(
                    'div',
                    { 
                        className: 'fpg-blog-layout-16 fancy-post-grid', 
                        style: { 
                            display: 'grid', 
                    ...
                    posts.map((post) => {
                        ...
                        return wp.element.createElement('div', { 
                            key: post.id, 
                                className: `fancy-post-item fpg-blog-layout-16-item align-${itemBoxAlignment9} ${hoverAnimation} ${postLinkType}`,
                                style: {
                                    ...(attributes.itemMargin
                                      ? { margin: getSpacingValue(attributes.itemMargin) }
                                      : { margin: '40px 0px 0px 0px' }), // your default fallback
                ...
                content = wp.element.createElement(
                          ...
                          wp.element.createElement('style', null, `
                              ...
                              .fpg-blog-layout-19-item .fpg-content a.fpg-btn.fpg-border::before {
                                  background: ${attributes.buttonHoverTextColor || '#332FFF'};
                              },
                          `),
                    wp.element.createElement(
                    'div',
                    { 
                        className: 'fpg-blog-layout-19 fancy-post-grid', 
                        style: { 
                            display: 'grid', 
                    ...
                    posts.map((post) => {
                        ...
                        return wp.element.createElement('div', { 
                            key: post.id, 
                                className: `fancy-post-item fpg-blog-layout-19-item align-${itemBoxAlignment10} ${hoverAnimation} ${postLinkType}`,
                                style: {
                            ...
                            wp.element.createElement('div', { className: 'fpg-content', style: {
                                ...
                                showReadMoreButton && wp.element.createElement('div', { 
                                    ...
                                    wp.element.createElement('a', { 
                                        href: post.link, 
                                        target: postLinkTarget === 'newWindow' ? '_blank' : '_self', 
                                        className: `fpg-btn read-more ${buttonStyle10}`,  // Dynamic class based on buttonStyle
                                        style: { 
                ...
                content = wp.element.createElement(
                          ...
                          wp.element.createElement('style', null, `
                              ...
                              .fpg-blog-layout-21-item .fpg-content .fpg-btn.fpg-border::before {
                                  background: ${attributes.buttonHoverTextColor || '#332FFF'};
                              },
                          `),
                  wp.element.createElement(
                    'div',
                    { 
                        className: 'fpg-blog-layout-21 fancy-post-grid', 
                        style: { 
                            display: 'grid', 
                    ...
                    posts.map((post) => {
                        ...
                        return wp.element.createElement('div', { 
                            key: post.id, 
                                className: `fancy-post-item fpg-blog-layout-21-item align-${itemBoxAlignment11} ${hoverAnimation} ${postLinkType}`,
                                style: {
                                    ...(attributes.itemMargin
                                      ? { margin: getSpacingValue(attributes.itemMargin) }
                                      : { margin: '40px 0px 0px 0px' }), // your default fallback
                            ...
                            wp.element.createElement('div', { className: 'fpg-content',style: {
                                ...
                                showReadMoreButton && wp.element.createElement('div', { 
                                    ...
                                    wp.element.createElement('a', { 
                                        href: post.link, 
                                        target: postLinkTarget === 'newWindow' ? '_blank' : '_self', 
                                        className: `fpg-btn read-more ${buttonStyle11}`,  // Dynamic class based on buttonStyle
                                        style: { 
                ...
                content = wp.element.createElement(
                          ...
                          wp.element.createElement('style', null, `
                              ...
                              .fpg-blog-layout-26-item .fpg-content .fpg-btn.fpg-border::before {
                                  background: ${attributes.buttonHoverTextColor || '#332FFF'};
                              },
                          `),
                  wp.element.createElement(
                    'div',
                    { 
                        className: 'fpg-blog-layout-26 fancy-post-grid', 
                        style: { 
                            display: 'grid', 
                    ...
                    posts.map((post) => {
                        ...
                        return wp.element.createElement('div', { 
                            key: post.id, 
                                className: `fancy-post-item fpg-blog-layout-26-item align-${itemBoxAlignment12} ${hoverAnimation} ${postLinkType}`,
                                style: {
                                    ...(attributes.itemMargin
                                      ? { margin: getSpacingValue(attributes.itemMargin) }
                            ...
                            wp.element.createElement('div', { className: 'fpg-content',style: {
                                ...
                                showReadMoreButton && wp.element.createElement('div', { 
                                    ...
                                    wp.element.createElement('a', { 
                                        href: post.link, 
                                        target: postLinkTarget === 'newWindow' ? '_blank' : '_self', 
                                        className: `fpg-btn read-more ${buttonStyle12}`,  // Dynamic class based on buttonStyle
                                        style: { 
                        ...
                        wp.element.createElement(TabPanel, {
                            ...
                            tab.name === 'content' ? wp.element.createElement('div', {}, 
                                ...
                                wp.element.createElement(PanelBody, { title: __('Field Selector', 'fancy-post-grid'), initialOpen: true },
                                    ...
                                    (gridLayoutStyle === 'style1' || gridLayoutStyle === 'style2' || gridLayoutStyle === 'style3' || gridLayoutStyle === 'style4' || gridLayoutStyle === 'style5' || gridLayoutStyle === 'style12') &&
                                    wp.element.createElement(ToggleControl, {
                                ...
                                wp.element.createElement(PanelBody, { title: __('Item Order', 'fancy-post-grid'), initialOpen: false },
                                    ...
                                    (gridLayoutStyle === 'style1' || gridLayoutStyle === 'style2' || gridLayoutStyle === 'style3' || gridLayoutStyle === 'style5' || gridLayoutStyle === 'style6' || gridLayoutStyle === 'style10' || gridLayoutStyle === 'style11' || gridLayoutStyle === 'style12') &&
                                    wp.element.createElement(RangeControl, {
                                ...
                                // Meta Data
                                (gridLayoutStyle === 'style1' || gridLayoutStyle === 'style2' || gridLayoutStyle === 'style3' || gridLayoutStyle === 'style4' || gridLayoutStyle === 'style6' || gridLayoutStyle === 'style7' || gridLayoutStyle === 'style8'|| gridLayoutStyle === 'style9'|| gridLayoutStyle === 'style10'|| gridLayoutStyle === 'style11' || gridLayoutStyle === 'style5') &&
                                ...
                                wp.element.createElement(PanelBody, { title: __('Content Box', 'fancy-post-grid'), initialOpen: false },
                                    ...
                                    (gridLayoutStyle === 'style1' || gridLayoutStyle === 'style2' || gridLayoutStyle === 'style3' || gridLayoutStyle === 'style4' || gridLayoutStyle === 'style6' || gridLayoutStyle === 'style7' || gridLayoutStyle === 'style8'|| gridLayoutStyle === 'style9'|| gridLayoutStyle === 'style10'|| gridLayoutStyle === 'style11' || gridLayoutStyle === 'style12') &&
                                    ...
                                    (gridLayoutStyle === 'style5' || gridLayoutStyle === 'style12') &&  
                                ...
                                wp.element.createElement(PanelBody, { title: __(' Meta Data', 'fancy-post-grid'), initialOpen: false },
                                    ...
                                    // Meta Bg Color
                                    (gridLayoutStyle === 'style3' || gridLayoutStyle === 'style4' || gridLayoutStyle === 'style5' || gridLayoutStyle === 'style6' || gridLayoutStyle === 'style7' || gridLayoutStyle === 'style8') &&
