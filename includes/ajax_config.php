...
function fpg_free_ajax_post_load_call_script() {
	wp_enqueue_script(
		'fpg-ajax-post-load',
...
add_action( 'wp_enqueue_scripts', 'fpg_free_ajax_post_load_call_script' );

/*
 * AJAX Load More
 */
function fpg_free_ajax_post_load_call_handler() {
...
add_action( 'wp_ajax_fpg_ajax_post_load', 'fpg_free_ajax_post_load_call_handler' );
add_action( 'wp_ajax_nopriv_fpg_ajax_post_load', 'fpg_free_ajax_post_load_call_handler' );

/*
 * AJAX Category Filter
 */
function fpg_free_ajax_category_filter_handler() {
	check_ajax_referer( 'fpg_ajax_post_load_nonce', 'nonce' );
...
add_action( 'wp_ajax_fpg_ajax_category_filter', 'fpg_free_ajax_category_filter_handler' );
add_action( 'wp_ajax_nopriv_fpg_ajax_category_filter', 'fpg_free_ajax_category_filter_handler' );
