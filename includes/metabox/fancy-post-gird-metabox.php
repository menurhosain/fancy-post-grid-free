...
class Fancy_Post_Grid_MetaBox {
    ...
    public function __construct() {
        add_action( 'add_meta_boxes', [ $this, 'fancy_post_grid_custom_settings_shortcode_metabox' ] );
        add_action( 'save_post', [ $this, 'fancy_post_grid_save_metabox_data' ] );
        add_action( 'admin_enqueue_scripts', [ $this, 'fancy_post_grid_metabox_enqueue_scripts' ] );
    }

    public function fancy_post_grid_custom_settings_shortcode_metabox() {
        add_meta_box(
     ...
     */
    public function fancy_post_grid_metabox_shortcode_callback( $post ) {
     ...
     */
    public function fancy_post_grid_save_metabox_data( $post_id ) {
     ...
     */
    public function fancy_post_grid_metabox_enqueue_scripts( $hook ) {
