...
if ($query->have_posts()) {
    ?>
    <div class="fpg-section-area fpg-blog-layout-6">
        <div class="row">
    <?php
    while ($query->have_posts()) {
        ...
        <div class="col-xl-<?php echo esc_attr($settings['col_desktop']); ?> 
            ...
            <?php 
                $layout = $settings['fancy_post_grid_layout'] ?? 'gridstyle02';
            ...
            <div class="fpg-blog__single fancy-post-item align-<?php echo esc_attr($box_alignment); ?>  mt-30 <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                <div class="fpg-content">
                    ...
                    <!-- Read More Button -->
                    <?php if (!empty($settings['show_post_readmore']) && 'yes' === $settings['show_post_readmore']) { $layout = $settings['fancy_post_grid_layout'] ?? 'gridstyle02';
                ...
                <?php if ('yes' === $settings['show_post_thumbnail'] && has_post_thumbnail()) { ?>
                    <div class="fpg-thumb">
                        ...
                        <?php 
                        // Set default thumbnail size based on layout if none selected
                        $layout = $settings['fancy_post_grid_layout'] ?? 'gridstyle02';
