...
if ($query->have_posts()) {
    ...
    ?>
    <div class="fpg-section-area fpg-blog-layout-13">
        <div class="row">
    <?php
    ...
    ?>
        <div class="col-xl-<?php echo esc_attr($settings['col_desktop']); ?> col-lg-<?php echo esc_attr($settings['col_lg']); ?> col-md-<?php echo esc_attr($settings['col_md']); ?> col-sm-<?php echo esc_attr($settings['col_sm']); ?> col-xs-<?php echo esc_attr($settings['col_xs']); ?> " >
            <?php 
                $layout = $settings['fancy_post_grid_layout'] ?? 'gridstyle06';
            ...
            ?>
            <div class="fpg-blog-layout-13-item fpg-blog__single fancy-post-item align-<?php echo esc_attr($box_alignment); ?> mt-30 <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                <!-- Featured Image -->
                ...
                <div class="fpg-content">
                    ...
                    <?php if (!empty($settings['show_post_readmore']) && 'yes' === $settings['show_post_readmore']) { 
                        $layout = $settings['fancy_post_grid_layout'] ?? 'gridstyle06';
                            $button_type = $settings['button_type'] ?? 'fpg-border';
                        ...
                        <div class="btn-wrapper">
                            <a href="<?php echo esc_url(get_permalink()); ?>" 
                               class="blog-btn read-more <?php echo esc_attr($button_type); ?>"
                               target="<?php echo 'new_window' === $settings['link_target'] ? '_blank' : '_self'; ?>">
                                <?php
