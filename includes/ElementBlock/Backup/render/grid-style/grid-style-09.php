...
if ($query->have_posts()) { ?>
    <div class="fpg-section-area fpg-blog-layout-16">
            <div class="row">
    <?php
    ...
    ?>
        <div class="col-xl-<?php echo esc_attr($settings['col_desktop']); ?> col-lg-<?php echo esc_attr($settings['col_lg']); ?> col-md-<?php echo esc_attr($settings['col_md']); ?> col-sm-<?php echo esc_attr($settings['col_sm']); ?> col-xs-<?php echo esc_attr($settings['col_xs']); ?> " >
            ...
            ?>
            <div class="fpg-blog-layout-16-item align-<?php echo esc_attr($box_alignment); ?> fpg-blog__single fancy-post-item mt-30 <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                <!-- Featured Image -->
                        ...
                        <div class="fpg-meta meta-data-list">
                            ...
                            $meta_items = array(
                                ...
                                'post_date' => array(
                                    ...
                                    'class'     => 'meta-date',
                                    'icon'      => ('yes' === $settings['show_meta_data_icon'] && 'yes' === $settings['show_post_date_icon']) ? '<i class="fa-regular fa-clock"></i>' : '',
