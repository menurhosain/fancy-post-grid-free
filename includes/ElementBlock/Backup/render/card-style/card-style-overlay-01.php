...
<section class="fpg-overlay-card-area section-space fpg-section-area">
    <div class="row">
        <?php while ($query->have_posts()) : $query->the_post(); ?>
            <?php if ($query->current_post === 0) : ?>
                ...
                <div class="col-xl-8 col-lg-8">
                    <?php 
                        $layout = $settings['fancy_post_card_layout'] ?? 'cardstyle08';
                    ...
                    <div class="fpg-post-overlay fpg-post-overlay-one <?php echo esc_attr($hover_animation); 
                        ?> <?php echo esc_attr($link_type); ?>">
                        <!-- Featured Image -->
                        <?php if ('yes' === $settings['show_post_thumbnail'] && has_post_thumbnail()) { ?>
                            <div class="fpg-post-overlay-bg-thumb fpg-thumb">
                                
                                <?php 
                                // Map the custom sizes to their actual dimensions
                                $layout = $settings['fancy_post_card_layout'] ?? 'cardstyle08';
                                $thumbnail_size = $settings['thumbnail_left_size_card'] ?? '';
                        ...
                        <div class="fpg-post-overlay-content align-<?php echo esc_attr($box_alignment); ?>">
                            <?php
                            // Get post categories
                            ...
                            <?php if (!empty($settings['show_post_title']) && 'yes' === $settings['show_post_title']) {
                                    ...
                                    <<?php echo esc_attr($title_tag); ?>
                                        class="title fpg-post-overlay-title is-white <?php echo esc_attr(implode(' ', $title_classes)); ?>"
                                        >
                            ...
                            <?php if ('yes' === $settings['show_meta_data']) { ?>
                                <div class="fpg-post-meta meta-white meta-data-list">
                                    <ul>
                                        <?php
                                        ...
                                        $meta_items = array(
                                            ...
                                            'post_date' => array(
                                                'condition' => 'yes' === $settings['show_post_date_card'],
                                                'class'     => 'fpg-meta',
                                                'icon'      => ('yes' === $settings['show_meta_data_icon'] && 'yes' === $settings['show_post_date_icon_card']) 
                ...
                <div class="col-lg-4">
                    <?php else : ?>
                        ...
                        ?>
                        <div class="fpg-post-list fpg-list-one <?php echo esc_attr($hover_animation); 
                        ?> <?php echo esc_attr($link_type); ?>">
                        <!-- Featured Image -->
                        <div class="item">
                            <div class="fpg-post-small fpg-post-small-one fpg-thumb">
                                <?php if ('yes' === $settings['show_post_thumbnail'] && has_post_thumbnail()) { ?>
                                    <div class="fpg-post-small-thumb">
                                        
                                        <?php 
                                        // Map the custom sizes to their actual dimensions
                                        $layout = $settings['fancy_post_card_layout'] ?? 'cardstyle08';
                                        $thumbnail_size = $settings['thumbnail_right_size_card'] ?? '';
                                ...
                                <div class="fpg-post-small-content align-<?php echo esc_attr($box_alignment); ?>">
                                    ...
                                    <?php if (!empty($settings['show_post_title']) && 'yes' === $settings['show_post_title']) {
                                            // Title Tag
                                            $title_secondaery_tag_card = !empty($settings['title_secondaery_tag_card']) ? esc_attr($settings['title_secondaery_tag_card']) : 'h6';
                                            ...
                                            // Rendering the Title
                                            ?>
                                            <<?php echo esc_attr($title_secondaery_tag_card); ?>
                                        ...
                                        <div class="fpg-post-meta meta-data-list">
                                            <ul class="meta-data-list-small">
                                                ...
                                                $meta_items = array(
                                                    ...
                                                    'post_views' => array(
                                                        'condition' => true, // <-- Always true, always show views
                                                        'class'     => 'fpg-meta',
                                                        'icon'      => '<i class="ri-pulse-fill"></i>',
                                                        'content'   => esc_html($post_views) . ' ' . esc_html__('Views', 'fancy-post-grid'),
                                                    ),
                                                );
