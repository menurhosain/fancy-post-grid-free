...
// Background Image
$bg_image = !empty($settings['custom_image']['url']) 
    ? esc_url($settings['custom_image']['url']) 
    : get_template_directory_uri() . '/assets/images/bg/video-bg-thumb-01.png';

// Video URL (depending on type)
$video_url = '';
if ($settings['video_type'] === 'youtube' || $settings['video_type'] === 'vimeo') {
    $video_url = !empty($settings['video_url']) ? esc_url($settings['video_url']) : '';
} elseif ($settings['video_type'] === 'self' && !empty($settings['self_video']['url'])) {
    $video_url = esc_url($settings['self_video']['url']);
}
...
<section class="fpg-video-area fpg-video-one fpg-video-two fpg-section-area">
    <div class="fpg-video-bg-thumb" 
    ...
    <div class="row justify-content-center">
        <div class="col-xl-12">
            <div class="fpg-video-wrapper text-center">
                <?php if ( !empty($video_url) ) : ?>
                    <div class="fpg-video-play-btn">
                        <a href="<?php echo esc_url( $video_url ); ?>" 
                            class="fpg-play-btn popup-video is-white">
        ...
        <div class="row g-15">
            <?php while ($query->have_posts()) : $query->the_post(); ?> 
                <div class="col-xl-4 col-lg-4">
                    <?php 
                        $layout = $settings['fancy_post_card_layout'] ?? 'cardstyle13';
                    ...
                    <div class="fpg-post-small fpg-post-small-ten <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                        ...
                        <?php if ('yes' === $settings['show_post_thumbnail'] && has_post_thumbnail()) { ?>
                            <div class="fpg-thumb fpg-post-small-thumb">
                                ...
                                $layout = $settings['fancy_post_card_layout'] ?? 'cardstyle05';
