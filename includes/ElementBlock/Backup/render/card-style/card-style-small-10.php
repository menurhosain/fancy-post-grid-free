...
if ($query->have_posts()) { ?>
    <div class="fpg-section-area fpg-small-card-area section-space">
            <div class="row">
    <?php
    ...
    ?>
        <div class="col-xl-<?php echo esc_attr($settings['col_desktop_card']); ?> col-lg-<?php echo esc_attr($settings['col_lg_card']); ?> col-md-<?php echo esc_attr($settings['col_md_card']); ?> g-15">
            <?php 
                $layout = $settings['fancy_post_card_layout'] ?? 'cardstyle17';
            ...
            ?>
            <div class="fpg-post-small fpg-post-small-twelve <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                <!-- Featured Image -->
