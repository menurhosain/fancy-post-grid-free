...
if ($query->have_posts()) { ?>
    <div class="fpg-section-area fpg-small-card-area section-space primary-bg">
            <div class="row">
            <?php
        ...
        <div class="col-xl-<?php echo esc_attr($settings['col_desktop_card']); ?> col-lg-<?php echo esc_attr($settings['col_lg_card']); ?> col-md-<?php echo esc_attr($settings['col_md_card']); ?> g-15">
            ...
            ?>
            <div class="fpg-post-small fpg-post-small-six <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                <!-- Featured Image -->
