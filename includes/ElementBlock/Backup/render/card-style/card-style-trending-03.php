...
<section class="fpg-trending-news-area fpg-trending-news-one primary-bg fpg-section-area">
    <div class="row">
        <?php while ($query->have_posts()) : $query->the_post(); ?>

            <?php if ($query->current_post % 2 === 0) : ?>
                <!-- First Post -->
                <div class="col-lg-4 g-15">
                    <div class="fpg-post-overlay fpg-post-overlay-two <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                        <?php if ('yes' === $settings['show_post_thumbnail'] && has_post_thumbnail()) : ?>
                            <div class="fpg-post-overlay-bg-thumb fpg-thumb">
                                <?php 
                                $thumbnail_size = $settings['thumbnail_right_size_card'] ?? 'fancy_post_portrait';
                        ...
                        <div class="fpg-post-overlay-content align-start">
                            <?php
                            // Get post categories
                            ...
                            <?php if (!empty($settings['show_post_title']) && 'yes' === $settings['show_post_title']) {
                                    ...
                                    <<?php echo esc_attr($title_secondaery_tag_card); ?>
                                        class="title fpg-post-overlay-title-card10 <?php echo esc_attr(implode(' ', $title_classes)); ?>"
                                        >
            ...
            <?php else : ?>
                <!-- Second Post -->
                <div class="col-xl-8 col-lg-8 g-15">
                    <div class="fpg-post-overlay fpg-post-overlay-two <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                        <?php if ('yes' === $settings['show_post_thumbnail'] && has_post_thumbnail()) : ?>
                            <div class="fpg-post-overlay-bg-thumb fpg-thumb">
                                <?php 
                                $thumbnail_size = $settings['thumbnail_left_size_card'] ?? 'fancy_post_list';
                                if ('yes' === $settings['thumbnail_link']) { ?>
                                    <a href="<?php the_permalink(); ?>" target="<?php echo ('new_window' === $settings['link_target']) ? '_blank' : '_self'; ?>">
                                        <?php the_post_thumbnail($thumbnail_size); ?>
                                    </a>
                        ...
                        <div class="fpg-post-overlay-content align-start">
                            ...
                            <?php if (!empty($settings['show_post_title']) && 'yes' === $settings['show_post_title']) {
                                    ...
                                    <<?php echo esc_attr($title_tag); ?>
                                        class="title fpg-post-overlay-title <?php echo esc_attr(implode(' ', $title_classes)); ?>"
                                        >
                                        <?php if ('link_details' === $settings['link_type']) { ?>
                                            <a href="<?php the_permalink(); ?>"
                                                target="<?php echo ('new_window' === $settings['link_target']) ? '_blank' : '_self'; ?>"
