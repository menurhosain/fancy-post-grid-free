...
<section class="fpg-trending-news-area fpg-trending-news-one fpg-section-area">
        <div class="row">
            <?php while ($query->have_posts()) : $query->the_post(); ?>

                <?php if ( $query->current_post === 1 || ( ( $query->current_post - 1 ) % 3 === 0 ) ) : ?>
                    <!-- First Post -->
                    ...
                    <?php 
                        $layout = $settings['fancy_post_card_layout'] ?? 'cardstyle07';
                    ...
                    ?>
                    <div class="fpg-post-medium fpg-post-medium-two <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                        <div class="fpg-post-medium-item">
                            ...
                            <?php if ('yes' === $settings['show_post_thumbnail'] && has_post_thumbnail()) { ?>
                                <div class="fpg-thumb fpg-post-medium-thumb">
                                    ...
                                    $layout = $settings['fancy_post_card_layout'] ?? 'cardstyle26';
