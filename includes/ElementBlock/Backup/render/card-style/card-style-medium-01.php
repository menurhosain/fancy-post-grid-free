...
if ($query->have_posts()) { ?>
    <div class="fpg-section-area fpg-medium-card-area section-space">
            <div class="row">
    <?php
    ...
    ?>
        <div class="col-xl-<?php echo esc_attr($settings['col_desktop_card']); ?> col-lg-<?php echo esc_attr($settings['col_lg_card']); ?> col-md-<?php echo esc_attr($settings['col_md_card']); ?> g-15">
            <?php 
                $layout = $settings['fancy_post_card_layout'] ?? 'cardstyle06';
            ...
            ?>
            <div class="fpg-post-medium fpg-post-medium-one <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                <div class="fpg-post-medium-item">
                    <!-- Featured Image -->
                    <?php if ('yes' === $settings['show_post_thumbnail'] && has_post_thumbnail()) { ?>
                        <div class="fpg-thumb fpg-post-medium-thumb">
                    ...
                    <div class="fpg-post-medium-content align-<?php echo esc_attr($box_alignment); ?>">
                        <?php
                            // Get post categories
                        ...
                        <?php if (!empty($settings['show_post_title']) && 'yes' === $settings['show_post_title']) {
                                ...
                                <<?php echo esc_attr($title_tag); ?>
                                    class="title fpg-post-medium-title <?php echo esc_attr(implode(' ', $title_classes)); ?>"
                                    >
                        ...
                        ?>  
                        <!-- Post Excerpt -->
                        <?php if ( 'yes' === $settings['show_post_excerpt_card'] ) { ?>
                            <p class="fancy-post-excerpt fpg-excerpt fpg-post-description" >
                                <?php
                                $excerpt_type = $settings['excerpt_type_card'];
                                $excerpt_length = $settings['excerpt_length_card'];
                                $expansion_indicator = $settings['expansion_indicator_card'];
