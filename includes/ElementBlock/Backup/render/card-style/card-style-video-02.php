...
<section class="fpg-video-card-area section-space fpg-section-area primary-bg">
    <div class="row g-15">
            ...
            <?php if ($query->current_post === 0) : ?>
                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="fpg-post-video fpg-post-video-one">
                        <?php 
                            $layout = $settings['fancy_post_card_layout'] ?? 'cardstyle12';
                        ...
                        <div class="fpg-post-video-item <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                            ...
                            <div class="ytbdVideo"
                                    data-property="{videoURL:'rxQQLQDtwfw', 
                                                    mute:true, 
                                                    showControls:true, 
                                                    loop:true, 
                                                    autoPlay:true, 
                                                    containment:'.ytbdVideo', 
                                                    startAt:0, 
                    ...
                    <?php else : ?>
                        ...
                        <div class="fpg-post-video-item <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                            ...
                            <div class="fpg-post-video-content align-<?php echo esc_attr($box_alignment); ?>">
                                ...
                                <!-- Post Meta: Date, Author, Category, Tags, Comments -->
                                <?php if ('yes' === $settings['show_meta_data']) { ?>
                                    <div class="fpg-post-meta meta-data-list meta-white">
                                        <ul>
                                            <?php
                                            // Get post views with a fallback default value.
                                            $post_id    = get_the_ID();
