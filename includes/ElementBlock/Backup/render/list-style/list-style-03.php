...
<section class="fpg-blog-layout-17 grey fpg-section-area">
        ...
        <?php while ($query->have_posts()) : $query->the_post(); ?>
            <?php if ($query->current_post === 0) : ?>
                ...
                <div class="col-lg-6">
                    ...
                    ?>
                    <div class="fpg-blog-layout-17-item align-<?php echo esc_attr($box_alignment); ?> <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                        <!-- Featured Image -->
                ...
                <div class="col-lg-6">
                    ...
                    <?php else : ?>
                        ...
                        <div class="fpg-blog-layout-17-item fpg-blog-layout-17-item-list align-<?php echo esc_attr($box_alignment); ?> <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                            <!-- Featured Image -->
                        <?php if ('yes' === $settings['show_post_thumbnail'] && has_post_thumbnail()) { ?>
                            <div class="fpg-thumb">
