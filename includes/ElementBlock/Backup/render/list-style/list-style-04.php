...
if ($query->have_posts()) {
    ?>
    <div class="fpg-section-area fpg-blog-layout-20">
            <div class="row">
    <?php
    ...
    ?>
        <div class="col-md-6">
            <?php 
                $layout = $settings['fancy_post_list_layout'] ?? 'liststyle04';
            ...
            ?>
            <div class="fpg-blog-layout-20-item align-<?php echo esc_attr($box_alignment); ?> <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                <!-- Featured Image -->
