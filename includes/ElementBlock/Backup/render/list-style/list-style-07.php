...
<?php if ($query->have_posts()) : ?>
    <section class="fpg-blog-layout-25 fpg-section-area">
        <div class="row fancy-post-grid">
            <div class="col-lg-12">
                ...
                ?>
                <div class="fpg-blog-layout-25-item align-<?php echo esc_attr($box_alignment); ?> <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                    <!-- Featured Image -->
