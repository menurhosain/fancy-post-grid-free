...
if ($query->have_posts()) { ?>
    <div class="fpg-section-area fpg-blog-layout-24">
            <div class="row">
    <?php
    ...
    ?>
        <div class="col-md-4">
            ...
            ?>
            <div class="fpg-blog-layout-24-item align-<?php echo esc_attr($box_alignment); ?> <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
                <!-- Featured Image -->
