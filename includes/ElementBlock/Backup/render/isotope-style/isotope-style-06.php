...
if ($query->have_posts()) { 
    ?>
    <section class="fpg-blog-layout-15 fpg-section-area">
        
        <div class="row">
            <div class="col-lg-12">
                <div class="fpg-blog-layout-6-filter fpg-blog-layout-filter">
        ...
        <div class="row fpg-grid" id="isotope-container">
            ...
            <div class="col-xl-<?php echo esc_attr($settings['col_desktop']); ?> col-lg-<?php echo esc_attr($settings['col_lg']); ?> col-md-<?php echo esc_attr($settings['col_md']); ?> col-sm-<?php echo esc_attr($settings['col_sm']); ?> col-xs-<?php echo esc_attr($settings['col_xs']); ?>  fpg-grid-item <?php echo esc_attr($category_classes); ?>" >
                ...
                ?>
                <div class="fpg-blog-layout-15-item fpg-blog__single align-<?php echo esc_attr($box_alignment); ?> fancy-post-item mt-30 <?php echo esc_attr($hover_animation); ?> <?php echo esc_attr($link_type); ?>">
