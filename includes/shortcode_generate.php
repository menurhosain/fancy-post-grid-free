 ...
 */
class Fancy_Post_Grid_Shortcde {
    ...
    public function __construct() {
        add_action( 'init', [ $this, 'fancy_post_grid_custom_post_type' ] );
        add_filter( 'enter_title_here', [ $this, 'fancy_post_grid_settings_admin_enter_title' ] );
        add_filter( 'post_updated_messages', [ $this, 'fancy_post_grid_settings_admin_updated_messages' ] );
        add_filter( 'manage_fancy-post-grid-fpg_posts_columns', [ $this, 'fancy_post_grid_settings_add_shortcode_column' ] );
        add_action( 'manage_fancy-post-grid-fpg_posts_custom_column', [ $this, 'fancy_post_grid_settings_add_posts_shortcode_display' ] ,10,2);
    }
    public function fancy_post_grid_custom_post_type() {
    ...
    public function fancy_post_grid_settings_admin_enter_title( $input ) {
        global $post_type;
        if ( 'fancy-post-grid-fpg' == $post_type )
            return esc_html__( 'Enter Shortcode Name', 'fancy-post-grid' );
        return $input;
    }
    public function fancy_post_grid_settings_admin_updated_messages( $messages ) {
        global $post, $post_id;
     ...
     */
    public function fancy_post_grid_settings_add_shortcode_column( $columns ) {
     ...
     */
    public function fancy_post_grid_settings_add_posts_shortcode_display( $column, $post_id ) {
        if ($column == 'shortcode'){
            ?>
